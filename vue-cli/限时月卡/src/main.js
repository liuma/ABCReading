...
router.beforeEach((to, from, next) => {
  ...
  if(monthCardCollageOpenid && monthCardCollageMemberid){
    ...
    window.location.href = common.config.gzhUrl + "v3/wechat/wechat/grant?state=H5&url="+encodeURIComponent(window.location.origin+'/mini_pay/mc/discount.html'+window.location.search);
  }
})

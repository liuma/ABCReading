...
// };
let WX_URL = process.env.NODE_ENV == 'development'?'http://dev.gzh.abctime.com/':"https://gzh.abctime.com/"
let GZH_URL = process.env.NODE_ENV == 'development'?'/apis/':"https://gzh.abctime.com/"
// let WX_URL = 'http://dev.gzh.abctime.com/',SIGN_KEY = ''
let SIGN_KEY = 'GriE93gIGp$5bDjQ4rc20FzxWGghTIau'
switch (process.env.NODE_ENV) {
    case 'dev':
      SIGN_KEY = 'GriE93gIGp$5bDjQ4rc20FzxWGghTIau' // dev
      WX_URL = 'http://dev.gzh.abctime.com/' // dev
      GZH_URL = 'http://dev.gzh.abctime.com/' // dev
      break
    case 'pre':
      SIGN_KEY = 'GriE93gIGp$5bDjQ4rc20FzxWGghTIau' // test
      WX_URL = 'http://test.gzh.abctime.com/' 
      GZH_URL = 'http://test.gzh.abctime.com/' 
      break
    case 'production':
      SIGN_KEY = 'hkf%t5SMv1HtrVS!Y%B!NPNS!!0cWgy' // 生产环境url
      WX_URL = 'https://gzh.abctime.com/' 
      GZH_URL = 'https://gzh.abctime.com/' 
      break
}
// 获取URL参数
...
const getParam = function (type,params,sign_key) {
  ...
  if(VL.getRequest().chid && VL.getRequest().chid>0){
    params.source_id = VL.getRequest().chid;
  }else{
  ...
  }else if(type=='get')
  {
    ...
    let signStr = p_arr.sort().join('~').replace(/~/g,'')+sign_key;

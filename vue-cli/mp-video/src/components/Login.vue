<template>
    <div class="login">
        <img class="hd" src="https://qnfile.abctime.com/abc_h5/mp/hd_login.png">
        <img class="logo" src="https://qnfile.abctime.com/abc_h5/mp/logo.png">
        <p class="txt_login">请使用ABC Reading账号登录</p>
        <div class="form_box">

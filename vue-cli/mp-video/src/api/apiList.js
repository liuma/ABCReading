...
export default {
  ...
  getHomeList(params) {   // 获取返现信息
    return get(baseUrl + 'v3/member/member-mini/lesson-list', params, header)  
  },
  cashApply(params) {
    return post(baseUrl + 'v3/punch/cash-back/apply', params, header2)
  },
  getBookList(params) {   // 获取返现信息
    return get(baseUrl + 'v3/member/member-mini/books', params, header)  
  },
  checkCard(params){

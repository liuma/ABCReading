  ...
  <div>
    <div class="collage">
      <div :class="shareStatus||sucTagStatus?'container blur':'container'">
        <img src="https://qnfile.abctime.com/abc_h5/collage_e/collage_banner.png" class="banner">
        <div class="time_box" v-show="!hideTimeout">
           距结束还剩<span>{{hour}}:{{minute}}:{{sister}}</span>
        </div>
        <div class="content_box">
          <p class="title">英语启蒙场景应用AI动画课</p>
          <div class="info">
            <div class="price">¥{{groupPrice}}<span>¥399</span></div>
            <div class="num"><span>{{suc_num}}</span>人已成团</div>
          </div>
          <p class="desc">哈佛大学教研老师专为学前孩子打造，32节课程的多情节教学。真正让孩子理解语言，运用语言。</p>
        </div>
        ...
        <img src="https://qnfile.abctime.com/abc_h5/collage_e/collage_info.png" class="info_pic">
...
export default {
  ...
  methods:{
    ...
    backCollage(){
      window.location.href = window.location.origin + '/mk/collage/'
    },
    toOrder(type,ne){
      if(ne){
        window.location.href = window.location.origin + '/mk/collage/'
    ...
    //     configObj.title = '【仅剩' + this.xNum + '人】39元拼团购买英语启蒙AI动画课'

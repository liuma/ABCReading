<template>
  <div class="order">
    <div class="order_container">
      ...
      <div class="txt_box">
        <p>购买成功后，下载“学而思轻课”APP</p>
        <p>输入购买时使用的手机号登录，即可享受课程权益</p>
      </div>
...
<script>
  ...
  methods: {
    getInfo(){
      ...
      let param = {type:type,member_id:member_id}
        ...
        if(res.data.code == 200){
          ...
          wx.chooseWXPay({
            ...
            success: function (res) {
                _this.$router.push({name:'Suc',query:{type:type}})
            }
          });
        }else{
          _this.showEject(res.data.msg)

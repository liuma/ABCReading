...
router.beforeEach((to, from, next) => {
  ...
  if(monthCardCollageOpenid && monthCardCollageMemberid){
    ...
    window.location.href = common.config.wechatUrl + "v3/wechat/wechat/grant?state=H5&url="+encodeURIComponent(window.location.origin + window.location.pathname + window.location.search);
  }
})

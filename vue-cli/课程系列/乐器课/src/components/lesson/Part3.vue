<template>
  <div class="game" id="game">
    ...
    <audio id="audio" class="Hidden" :src="titleSrc" controls></audio>
  ...
  export default {
    ...
    methods: {
      ...
      endDrag (args) {
        ...
        if((currentLeft>targetLeft-currentLeft) && (currentLeft<targetLeft+targetWidth)
          && (currentTop>targetTop) && (currentTop<targetTop+targetHeight) && flag>0
        ){

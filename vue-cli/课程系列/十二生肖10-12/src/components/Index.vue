    ...
    <div class="container">
      <div class="head">
        ...
        <div class="lesson_info">
            ...
            <div class="lesson_price">
                <div>¥<span class="group_price">24</span>.90
      ...
      <div class="init_ft" v-show="!direct_buy&&!selfSuc&&!has_group">
        ...
        <div class="discount" @click="join()">
          <span class="price">立即参团¥24.90</span>
      ...
      <div class="ft2" v-show="!direct_buy&&!selfHasGroup&&has_group">
          ...
          <div v-if="!is_full" class="btn join_btn" @click="join()">立即参团24.90</div>
      ...
      getMemberInfo(){
        ...
        this.$axios.get(userUrl+'?'+fd).then((res) => {
          if(res.data.code == 200){
            ...
            window.localStorage.setItem('extendAbcMemberid',res.data.data.id)

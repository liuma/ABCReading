<template>
  <div class="pay">
    <div class="pay_container">
      ...
      <div class="main">
        <div class="info_box">
          <img :src="configData.imgUrl">
          <p class="title">趣讲生肖知识，破译文化密码</p>
          <p class="price"><span class="discount">¥<span>24</span>.9</span><span class="original">￥99.00</span></p>
        ...
        <div class="btn pay_btn" v-show="!direct_buy && !selfHaveGroup" @click="joinGroup()">立即支付(¥24.90)</div>
  ...
  export default {
    ...
    data () {
      return {
        ...
        canPay:true,
        configData:{
            title:'揭秘生肖背后的故事，收获多样知识！',
            desc: '妙趣横生地学习生肖有关的历史、文化、生物、民俗等多方面知识。',
            imgUrl: 'https://qnfile.abctime.com/extend/list_share10.png',
        },
        lessonUrl: '/extend/sx/index.html',
      }
    },
    created(){
      // this.shareConfig()

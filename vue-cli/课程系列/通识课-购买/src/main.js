...
router.beforeEach((to, from, next) => {
  ...
  if(extendAbcOpenid && extendAbcMemberid){
    ...
    window.location.href = common.config.gzhUrl + "v3/wechat/wechat/grant?state=H5&url="+encodeURIComponent(window.location.origin+'/extend/lab/index.html'+window.location.search);
  }

  ...
  <div content="index" id="index_wrap">
    <div class="container">
      <div class="head">
        ...
        <div class="lesson_info">
            ...
            <div class="lesson_price">
                <div>¥<span class="group_price">19</span>.90
                    <span class="direct_price">79.00</span>
        ...
        <div class="index_content" id="index_content">
          ...
          <div class="content">
            <div id="con1">
                <img src="../assets/imgs/index_info1.png">
            </div>
            <div id="con2">
      ...
      <div class="init_ft" v-show="!direct_buy&&!selfSuc&&!has_group">
        <div class="original" @click="buy()">￥79.00<div>原价购买</div></div>
        <div class="discount" @click="join()">
          <span class="price">立即参团¥19.90</span>
          <div>3人拼团 原价<span>￥79.00</span></div>
        </div>
      </div>
      <!-- 购买成功（直接购买||拼团成功） -->
      ...
      <div class="ft2" v-show="!direct_buy&&!selfHasGroup&&has_group">
          ...
          <div v-if="!is_full" class="btn join_btn" @click="join()">立即参团19.90</div>
          <div v-else class="btn join_btn" @click="backSelf()">发起新团</div>
          <div class="direct_btn" @click="buy()">原价购买 ￥79.00</div>
      </div>
      <!-- 已购买，未满 -->
  ...
  export default {
    ...
    data(){
      return{
        ...
        configData:{
            title:'孩子情商教育的必备课',
            desc: '学习社交方法，全面解锁五大沟通能力，塑造健康自信的人格魅力！',
            imgUrl: 'https://qnfile.abctime.com/extend/list_share11.png',
        },
        lessonUrl: '/extend/rjgt/index.html',
      }
    },
    created(){
    },

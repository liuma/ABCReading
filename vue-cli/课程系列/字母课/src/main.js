...
router.beforeEach((to, from, next) => {
  let nameArr = ['Part','PartOne','PartTwo','PartFour','Finish'],nameArr2 = ['Cata','PartThree']
  ...
  if(extendAbcOpenid && extendAbcMemberid){
    ...
    window.location.href = common.config.gzhUrl + "v3/wechat/wechat/grant?state=H5&url="+encodeURIComponent(window.location.origin+'/extend/letter/index.html'+window.location.search);
  }
})

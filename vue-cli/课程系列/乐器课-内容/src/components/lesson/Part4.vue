<template>
  <div class="part4">
    ...
    <div class="video_wrap">
      ...
      <video id="video1" ref="video1" :preload="true" x5-playsinline="" playsinline="" webkit-playsinline="" poster="" preload="auto" :src="url" @ended="onEnded" @canplay="canPlay"></video>
      <div class="play_tag" @click="isRecord?stopRecord():startRecord()" v-show="!isPlaying"></div>
    </div>
  ...
  .part4{
    ...
    .video_wrap{
      ...
      .play_tag{
        width: 1.64rem;
        height: 1.2rem;
        background: url('../../assets/imgs/play_tag.png');
        background-size: cover;
        position: absolute;
        top: calc(~'50% - .6rem');
        left: calc(~'50% - .82rem');

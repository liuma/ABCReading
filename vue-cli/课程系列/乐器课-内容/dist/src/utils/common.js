...
var getParam = function getParam(type, params, sign_key) {
  ...
  // params.act_id = 5;
  // params.source_id = 109;
  if (type == 'post') {
    for (var i in params) {
      name_arr.push(i);
      value_arr.push(params[i]);
      if ((0, _typeof3.default)(params[i]) != 'object') {
...
//微信分享
// 获取参数url  分享配置  是否禁止分享
var share = function share(shareUrl, configObj, isHide) {
  var apiList = [];
  if (isHide == 1) {
  ...
  requestGet(shareUrl, { url: encodeURIComponent(window.location.href) }, function (data) {
    if (data.code == 200) {
...
//吸顶效果
var fixTop = function fixTop(obj) {
...
exports.default = { config: config, VL: VL, getParam: getParam, GetRequest: GetRequest, timestampToTime: timestampToTime, fixTop: fixTop, share: share };

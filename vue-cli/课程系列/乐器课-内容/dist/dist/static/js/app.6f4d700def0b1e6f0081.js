...
webpackJsonp([1], { "+Fy0": function Fy0(t, e) {}, "8ZZI": function ZZI(t, e) {}, BbxL: function BbxL(t, e) {}, CUz2: function CUz2(t, e) {}, FfsX: function FfsX(t, e) {}, MBBj: function MBBj(t, e) {}, NHnr: function NHnr(t, e, i) {
    "use strict";
    Object.defineProperty(e, "__esModule", { value: !0 });var n = i("7+uW"),
      ...
      i("BbxL");
        ...
        w = i("mvHQ"),
        x = i.n(w),
        y = { name: "Part", components: { eject: h }, data: function data() {
      ...
      i("8ZZI");
        ...
        k = i.n($),
        T = i("DNVT"),
        P = { name: "perfect", data: function data() {
      ...
      i("+Fy0");
        ...
        return { songArr: [], tagArr: [!1, !1, !1, !1, !1, !1, !1, !1], localIdArr: [], recordFlag: !1, url: "", song_txt: "", currentId: -1, proLeft: 0, localId: "", perStatus: !1, isRecord: !1, saveInd: 0, part4_guide: !1, showFinish: !1, allTime: 0, isPlaying: !1 };
      }, mounted: function mounted() {
        var t = localStorage.getItem("extendAbcPart4Guide");this.part4_guide = !t, this.setSrc(), this.localIdArr = [], this.isRecord = !1;var e = this;this.$nextTick(function () {
          ...
          var t = this.$route.query.id;wx.ready(function () {
            wx.stopRecord({ success: function success(t) {} });
          }), this.$router.replace({ name: "Part", query: { id: t } });
          ...
          var t = this;wx.ready(function () {
            t.isRecord = !0, wx.startRecord();var e = document.getElementById("video1");e.style.display = "inline-block", e.play(), t.isPlaying = !0;
          });
          ...
          var t = this;wx.ready(function () {
            wx.stopRecord({ success: function success(e) {
                t.isRecord = !1, t.localId = e.localId;var i = document.getElementById("video1");i.pause(), i.currentTime = 0, i.style.display = "none", t.isPlaying = !1, t.showPerfect();
              } });
          });
        ...
        var t = this,
            ...
            i = t._self._c || e;return i("div", { staticClass: "part4" }, [i("div", { staticClass: "back", on: { click: function click(e) {
              return t.back();
            } } }), t._v(" "), i("div", { staticClass: "video_wrap" }, [i("video", { ref: "video1", attrs: (_attrs = { id: "video1", preload: !0, "x5-playsinline": "", playsinline: "", "webkit-playsinline": "", poster: "" }, (0, _defineProperty3.default)(_attrs, "preload", "auto"), (0, _defineProperty3.default)(_attrs, "src", t.url), _attrs), on: { ended: t.onEnded, canplay: t.canPlay } }), t._v(" "), i("div", { directives: [{ name: "show", rawName: "v-show", value: !t.isPlaying, expression: "!isPlaying" }], staticClass: "play_tag", on: { click: function click(e) {
              t.isRecord ? t.stopRecord() : t.startRecord();
            } } })]), t._v(" "), i("div", { staticClass: "record_box" }, [i("div", { staticClass: "btn_record" }), t._v(" "), i("div", { staticClass: "start_record", on: { click: function click(e) {
              t.isRecord ? t.stopRecord() : t.startRecord();
            } } }), t._v(" "), i("div", { staticClass: "btn_repeat", on: { click: function click(e) {
              return t.playVo();
        ...
        var t = this.$createElement,
            e = this._self._c || t;return e("div", { staticClass: "hv_tip" }, [e("div", { staticClass: "icon" }), this._v(" "), e("p", [this._v("请旋转至横屏，体验更佳")])]);
      }] };var O = i("VU/8")(M, U, !1, function (t) {
      i("QH01");
    }, "data-v-07fd192d", null).exports,
      ...
      i("FfsX");
        ...
        H = { name: "Part", data: function data() {
        return { titleTxt: "" };
      ...
      }, staticRenderFns: [] };var G = i("VU/8")(H, Y, !1, function (t) {
      i("ix0t");
    }, null, null).exports,
        z = i("MJLE"),
        J = i.n(z),
      ...
      i("CUz2");
    }, "data-v-45ac8c0b", null).exports;n.a.use(d.a);var st = new d.a({ routes: [{ path: "/", name: "Cata", component: f }, { path: "/partOne", name: "PartOne", component: A }, { path: "/partTwo", name: "PartTwo", component: F }, { path: "/partThree", name: "PartThree", component: B }, { path: "/partFour", name: "PartFour", component: O }, { path: "/partFive", name: "PartFive", component: X }, { path: "/cata", name: "Cata", component: f }, { path: "/trans", name: "Transition", component: _ }, { path: "/part", name: "Part", component: S }, { path: "/finish", name: "Finish", component: G }, { path: "/end", name: "End", component: nt }] }),
        at = i("pFYg"),
        ot = i.n(at),
        rt = { baseUrl: "https://api.abctime.com/", gzhUrl: "http://gzh.abctime.com/", sign_key: "hkf%t5SMv1HtrVS!Y%B!NPNS!!0cWgy", postConfig: { headers: { "Content-Type": "multipart/form-data" } } },
      ...
      var e = 8,
        ...
        var i,
          ...
          i = C[0], l = C[1], h = C[2], m = C[3], p = C[4], f = C[5], v = C[6], g = C[7];for (var I = 0; I < 64; I++) {
            S[I] = I < 16 ? t[I + b] : n(n(n(s(x = S[I - 2], 17) ^ s(x, 19) ^ a(x, 10), S[I - 7]), u(S[I - 15])), S[I - 16]), _ = n(n(n(n(g, d(p)), o(p, f, v)), y[I]), S[I]), w = n(c(i), r(i, l, h)), g = v, v = f, f = p, p = n(m, _), m = h, h = l, l = i, i = n(_, w);
          }C[0] = n(i, C[0]), C[1] = n(l, C[1]), C[2] = n(h, C[2]), C[3] = n(m, C[3]), C[4] = n(p, C[4]), C[5] = n(f, C[5]), C[6] = n(v, C[6]), C[7] = n(g, C[7]);
        }return C;
      }(function (t) {
  ...
  }, QH01: function QH01(t, e) {}, QSjF: function QSjF(t, e) {}, WKTL: function WKTL(t, e) {}, g4Xu: function g4Xu(t, e) {}, hyyX: function hyyX(t, e) {}, ix0t: function ix0t(t, e) {}, nFDG: function nFDG(t, e) {}, xtlR: function xtlR(t, e) {} }, ["NHnr"]);
//# sourceMappingURL=app.6f4d700def0b1e6f0081.js.map
//# sourceMappingURL=app.6f4d700def0b1e6f0081.js.map
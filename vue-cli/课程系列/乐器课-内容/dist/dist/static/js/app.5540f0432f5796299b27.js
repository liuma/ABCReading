...
webpackJsonp([1], { "+Fy0": function Fy0(t, e) {}, "8ZZI": function ZZI(t, e) {}, BbxL: function BbxL(t, e) {}, Divx: function Divx(t, e) {}, MBBj: function MBBj(t, e) {}, NHnr: function NHnr(t, e, i) {
    "use strict";
    Object.defineProperty(e, "__esModule", { value: !0 });var s = i("7+uW"),
        ...
        this.setData();
          ...
          var e = parseInt(t.target.attributes.flag.value),
            ...
            if (this.playAudio("https://qnfile.abctime.com/right.mp3"), i.indexOf("drag1") >= 0) {
              this.imgLeft1 = this.posX + t.deltaX - (a - o), this.imgTop1 = this.posY + t.deltaY - (n - c);var u = this;setTimeout(function () {
                document.getElementsByClassName("default_1")[s].className = "default_1 active", u.imgLeft1 = 0, u.imgTop1 = 0, u.page++, u.autoPlayTitleAudio(u.gameArr[u.page].title), document.getElementById("game").scrollLeft += 500;
              }, 2e3);
            } else if (i.indexOf("drag2") >= 0) {
              this.imgLeft2 = this.posX + t.deltaX - (a - o), this.imgTop2 = this.posY + t.deltaY - (n - c);var l = this;setTimeout(function () {
                document.getElementsByClassName("default_1")[s].className = "default_1 active", l.imgLeft2 = 0, l.imgTop2 = 0, l.page++, l.playTitleAudio(l.gameArr[l.page].title), document.getElementById("game").scrollLeft += 500;
              }, 2e3);
            }
          ...
          var e = parseInt(t.target.attributes.flag.value),
            ...
            if (this.playAudio("https://qnfile.abctime.com/right.mp3"), i.indexOf("drag3") >= 0) {
              this.senLeft1 = this.posX + t.deltaX - (a - o), this.senTop1 = this.posY + t.deltaY - (n - c);var u = this;setTimeout(function () {
                document.getElementsByClassName("default_2")[s].className = "default_2 active", u.senLeft1 = 0, u.senTop1 = 0, u.page++, 5 == u.page && u.activeGame();
              }, 2e3);
            } else if (i.indexOf("drag4") >= 0) {
              this.playAudio("https://qnfile.abctime.com/right.mp3"), this.senLeft2 = this.posX + t.deltaX - (a - o), this.senTop2 = this.posY + t.deltaY - (n - c);var l = this;setTimeout(function () {
                document.getElementsByClassName("default_2")[s].className = "default_2 active", l.senLeft2 = 0, l.senTop2 = 0, l.page++, 5 == l.page && l.activeGame();
              }, 2e3);
            }
      ...
      }, staticRenderFns: [] };var M = i("VU/8")(V, N, !1, function (t) {
      i("+Fy0");
    }, "data-v-4c9647b0", null).exports,
        B = { name: "part4", components: { perject: R }, data: function data() {
        ...
        var t = this,
            ...
            i = t._self._c || e;return i("div", { staticClass: "part4" }, [i("div", { staticClass: "back", on: { click: function click(e) {
              return t.back();
            } } }), t._v(" "), i("div", { staticClass: "video_wrap" }, [i("video", { ref: "video1", attrs: (_attrs = { preload: !0, "x5-playsinline": "", playsinline: "", "webkit-playsinline": "", poster: "" }, (0, _defineProperty3.default)(_attrs, "preload", "auto"), (0, _defineProperty3.default)(_attrs, "src", t.url), (0, _defineProperty3.default)(_attrs, "controls", "false"), _attrs), on: { ended: t.onEnded, canplay: t.canPlay } })]), t._v(" "), i("div", { staticClass: "record_box" }, [i("div", { staticClass: "btn_record" }), t._v(" "), i("div", { staticClass: "start_record", on: { click: t.onPlay } }), t._v(" "), i("div", { staticClass: "btn_repeat", on: { click: function click(e) {
              return t.playVo();
        ...
        var t = this.$createElement,
            e = this._self._c || t;return e("div", { staticClass: "hv_tip" }, [e("div", { staticClass: "icon" }), this._v(" "), e("p", [this._v("请旋转至横屏，体验更佳")])]);
      }] };var U = i("VU/8")(B, O, !1, function (t) {
      i("X/Dw");
    }, "data-v-9f86d04e", null).exports,
        ...
        var t = localStorage.getItem("extendAbcPart4Guide");this.part4_guide = !t, this.setSrc(), this.localIdArr = [], this.isRecord = !1;var e = this;this.$nextTick(function () {
          ...
          var t = this,
              ...
              s = this.$common.getParam("get", { course_id: 2, member_id: e });this.$axios.get(i + "?" + s).then(function (e) {
            if (200 == e.data.code) {
              t.courseArr = e.data.data.list;var i = !1;for (var s in t.courseArr) {
                if (!t.courseArr[s].is_finish) {
                  var a = "extendAbcFinish" + t.courseArr[s].id;localStorage.getItem(a) || (t.showFinish = !0, t.next_id = parseInt(t.courseArr[s].id), t.next_cover = t.courseArr[s].cover, i = !1);break;
                }i = !0;
              }i && t.$router.push({ name: "End" });
            }
          });
        }, setData: function setData() {
          var t = JSON.parse(window.localStorage.getItem("musicalContent"));for (var e in this.songArr = t.song.resource, this.songArr) {
      ...
      }, staticRenderFns: [] };var Y = i("VU/8")(G, H, !1, function (t) {
      i("ix0t");
    }, null, null).exports,
        J = i("MJLE"),
        z = i.n(J),
        ...
        var t = this,
            e = t.$createElement,
            i = t._self._c || e;return i("div", { staticClass: "end" }, [t._m(0), t._v(" "), i("div", { directives: [{ name: "show", rawName: "v-show", value: t.wrapShow, expression: "wrapShow" }], staticClass: "wrap" }, [i("img", { directives: [{ name: "show", rawName: "v-show", value: !t.loadStatus, expression: "!loadStatus" }], staticClass: "posterImg", attrs: { src: t.posterImg, alt: "" } }), t._v(" "), i("p", { directives: [{ name: "show", rawName: "v-show", value: !t.loadStatus, expression: "!loadStatus" }], staticClass: "save_txt" }, [t._v("长按图片保存奖状")]), t._v(" "), i("div", { directives: [{ name: "show", rawName: "v-show", value: t.loadStatus, expression: "loadStatus" }], staticClass: "loading" }, [t._m(1), t._v(" "), i("p", [t._v("海报生成中...")])])])]);
      }, staticRenderFns: [function () {
        var t = this.$createElement,
            e = this._self._c || t;return e("div", { staticClass: "poster_wrap" }, [e("div", { staticClass: "poster", attrs: { id: "posterHtml" } }, [e("img", { attrs: { src: "https://qnfile.abctime.com/extend/musical/poster.png", alt: "poster" } })])]);
      }, function () {
        var t = this,
            e = t.$createElement,
      ...
      i("ehIH");
    }, "data-v-30e55f6c", null).exports;s.a.use(d.a);var at = new d.a({ routes: [{ path: "/", name: "Cata", component: f }, { path: "/partOne", name: "PartOne", component: A }, { path: "/partTwo", name: "PartTwo", component: F }, { path: "/partThree", name: "PartThree", component: M }, { path: "/partFour", name: "PartFour", component: U }, { path: "/partFive", name: "PartFive", component: X }, { path: "/cata", name: "Cata", component: f }, { path: "/trans", name: "Transition", component: _ }, { path: "/part", name: "Part", component: S }, { path: "/finish", name: "Finish", component: Y }, { path: "/end", name: "End", component: st }] }),
        nt = i("pFYg"),
        ot = i.n(nt),
      ...
      var e = 8,
        ...
        var i,
          ...
          i = y[0], l = y[1], h = y[2], m = y[3], p = y[4], f = y[5], v = y[6], g = y[7];for (var b = 0; b < 64; b++) {
            S[b] = b < 16 ? t[b + I] : s(s(s(a(x = S[b - 2], 17) ^ a(x, 19) ^ n(x, 10), S[b - 7]), u(S[b - 15])), S[b - 16]), _ = s(s(s(s(g, d(p)), o(p, f, v)), C[b]), S[b]), w = s(c(i), r(i, l, h)), g = v, v = f, f = p, p = s(m, _), m = h, h = l, l = i, i = s(_, w);
          }y[0] = s(i, y[0]), y[1] = s(l, y[1]), y[2] = s(h, y[2]), y[3] = s(m, y[3]), y[4] = s(p, y[4]), y[5] = s(f, y[5]), y[6] = s(v, y[6]), y[7] = s(g, y[7]);
        }return y;
      }(function (t) {
        ...
        ht = i.n(lt),
        mt = i("I0MY"),
        pt = i.n(mt);s.a.use(ht.a), s.a.use(pt.a, { name: "v-touch" }), s.a.config.productionTip = !1, s.a.prototype.$axios = n.a, s.a.prototype.$common = ut, at.beforeEach(function (t, e, i) {
  ...
  }, QSjF: function QSjF(t, e) {}, WKTL: function WKTL(t, e) {}, "X/Dw": function XDw(t, e) {}, ehIH: function ehIH(t, e) {}, g4Xu: function g4Xu(t, e) {}, hyyX: function hyyX(t, e) {}, ix0t: function ix0t(t, e) {}, nFDG: function nFDG(t, e) {}, xtlR: function xtlR(t, e) {} }, ["NHnr"]);
//# sourceMappingURL=app.5540f0432f5796299b27.js.map
//# sourceMappingURL=app.5540f0432f5796299b27.js.map
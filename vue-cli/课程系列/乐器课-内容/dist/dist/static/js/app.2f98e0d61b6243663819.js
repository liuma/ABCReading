...
webpackJsonp([1], { "0a+T": function aT(t, e) {}, "8ZZI": function ZZI(t, e) {}, B9x8: function B9x8(t, e) {}, GNMY: function GNMY(t, e) {}, NHnr: function NHnr(t, e, i) {
    "use strict";
    Object.defineProperty(e, "__esModule", { value: !0 });var s = i("7+uW"),
      ...
      i("mdx6");
    }, "data-v-8638ec52", null).exports,
        v = { name: "Part", components: { eject: h }, data: function data() {
        return { ind: 0, id: 0, num: 2, ejectText: "", ejectStatus: !1, textArr: ["视频欣赏", "绘本阅读", "互动游戏", "动画歌谣"], audio_url: "" };
      }, created: function created() {}, mounted: function mounted() {
        this.ind = this.$route.query.part - 1 || 0, this.id = this.$route.query.id, document.querySelector("#audio").src = "https://qnfile.abctime.com/extend/musical/trans_audio" + this.$route.query.part + ".mp3", alert("setSrc"), wx.ready(function () {
      ...
      i("8ZZI");
        ...
        T = i.n($),
        E = i("DNVT"),
        k = { name: "perfect", data: function data() {
      ...
      i("QSjF");
        ...
        var t = localStorage.getItem("extendAbcPart2Guide");this.part2_guide = !t;var e = this;this.setData(), this.localIdArr = [], new E.a(".swiper-container", { loop: !1, observer: !0, on: { slideChange: function slideChange() {
      ...
      i("mtJz");
    }, "data-v-c87ea084", null).exports,
        N = { name: "Part3", data: function data() {
      ...
      }, staticRenderFns: [] };var O = i("VU/8")(N, V, !1, function (t) {
      i("GNMY");
    }, "data-v-fadd1fb8", null).exports,
        U = { name: "part4", components: { perject: j }, data: function data() {
        ...
        var t = this.$createElement,
            e = this._self._c || t;return e("div", { staticClass: "hv_tip" }, [e("div", { staticClass: "icon" }), this._v(" "), e("p", [this._v("请旋转至横屏，体验更佳")])]);
      }] };var D = i("VU/8")(U, M, !1, function (t) {
      i("B9x8");
    }, "data-v-517de4df", null).exports,
        X = { name: "part4", components: { perject: j }, data: function data() {
        ...
        var t = this.$createElement,
            e = this._self._c || t;return e("div", { staticClass: "hv_tip" }, [e("div", { staticClass: "icon" }), this._v(" "), e("p", [this._v("请旋转至横屏，体验更佳")])]);
      }] };var G = i("VU/8")(X, B, !1, function (t) {
      i("mXAn");
    }, "data-v-a23f5e36", null).exports,
        Y = { name: "Part", data: function data() {
        return { titleTxt: "" };
      ...
      }, staticRenderFns: [] };var W = i("VU/8")(Y, H, !1, function (t) {
      i("ix0t");
    }, null, null).exports,
        z = i("MJLE"),
        Q = i.n(z),
        ...
        this.createQrcode(location.origin + "/extend/letter/index.html");
          ...
          console.log(t);var e = document.getElementById("qrcodeImg"),
              i = 54 * document.documentElement.clientWidth / 1334;e.innerHTML = "", new Q.a(e, { width: i, height: i, colorDark: "#000000", colorLight: "#ffffff", correctLevel: Q.a.CorrectLevel.H }).makeCode(t), this.getPoster();
      ...
      i("yyjV");
    }, "data-v-1023c712", null).exports;s.a.use(d.a);var at = new d.a({ routes: [{ path: "/", name: "Cata", component: f }, { path: "/partOne", name: "PartOne", component: A }, { path: "/partTwo", name: "PartTwo", component: F }, { path: "/partThree", name: "PartThree", component: O }, { path: "/partFour", name: "PartFour", component: D }, { path: "/partFive", name: "PartFive", component: G }, { path: "/cata", name: "Cata", component: f }, { path: "/trans", name: "Transition", component: _ }, { path: "/part", name: "Part", component: S }, { path: "/finish", name: "Finish", component: W }, { path: "/end", name: "End", component: st }] }),
        nt = i("pFYg"),
        ot = i.n(nt),
  ...
  }, Q3O9: function Q3O9(t, e) {}, QSjF: function QSjF(t, e) {}, WKTL: function WKTL(t, e) {}, hyyX: function hyyX(t, e) {}, ix0t: function ix0t(t, e) {}, mXAn: function mXAn(t, e) {}, mdx6: function mdx6(t, e) {}, mtJz: function mtJz(t, e) {}, nFDG: function nFDG(t, e) {}, yyjV: function yyjV(t, e) {} }, ["NHnr"]);
//# sourceMappingURL=app.2f98e0d61b6243663819.js.map
//# sourceMappingURL=app.2f98e0d61b6243663819.js.map
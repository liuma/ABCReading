    ...
    <div class="pay_container">
      ...
      <div class="main">
        <div class="info_box">
          ...
          <p class="title">把实验室搬回家，科学常识任意学！</p>
          <p class="price"><span class="discount">¥<span>29</span>.9</span><span class="original">￥99.00</span></p>
        ...
        <div class="btn pay_btn" v-show="!direct_buy && !selfHaveGroup" @click="joinGroup()">立即支付(¥29.90)</div>
    ...
    methods: {
      ...
      getPoster(){
        ...
        if(vid > 0){
          if(this.haveGroup){
            if(this.isSelf){
              link = window.location.origin + '/extend/lab/index.html?view_member_id=' + member_id
            }else {
              link = window.location.origin + '/extend/lab/index.html?view_member_id=' + vid
            }
          }else {
            link = window.location.origin + '/extend/lab/index.html?view_member_id=' + member_id
          }
      ...
      shareConfig(){
        ...
        let link = '',_this=this;
        let configObj = {
          title:'把实验室搬回家，科学常识任意学！',
          desc: '65个科学实验，培养孩子的科学思维',
          imgUrl: 'https://qnfile.abctime.com/extend/lab_share.png',
        };
        let vid = this.$common.VL.getRequest().view_member_id
        if(vid > 0){
          if(this.haveGroup){
        ...
        if(this.haveGroup && this.xNum > 0){
          configObj.title = '仅差' + this.xNum + '人拼团成功！把实验室搬回家，科学常识任意学！'
          configObj.desc = '65个科学实验，培养孩子的科学思维'
        }
